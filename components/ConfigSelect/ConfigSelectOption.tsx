...
export const ConfigSelectOption: FunctionComponent<Props> = ({ option }) => (
  <div className="w-96 h-20 rounded-xl bg-gray-200  hover:bg-gray-100">
    ...
    <p className="m-7 mt-xsm pb-10 text-sm text-gray-500 inline-block">{option.description}</p>
    <button className="-pt-xxxsm right-4 inline absolute" type="button" onClick={option.onClick}>
